    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='Template name (e.g., Initial Consultation Form)', max_length=200, unique=True)),
                ('code', models.CharField(help_text='Unique template code', max_length=50, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('tenant_id', models.UUIDField(db_index=True, help_text='Tenant identifier for multi-tenancy')),
                ('name', models.CharField(help_text='Group name (e.g., General Examination)', max_length=200, unique=True)),
                ('description', models.TextField(blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('billed_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='created_procedure_bills', to=settings.AUTH_USER_MODEL)),
                ('doctor', models.ForeignKey(help_text='Doctor who ordered the procedures', on_delete=django.db.models.deletion.PROTECT, related_name='ordered_procedures', to='doctors.doctorprofile')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['code'], name='proc_master_code_idx'), models.Index(fields=['category'], name='proc_master_category_idx'), models.Index(fields=['is_active'], name='proc_master_active_idx')],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.DecimalField(decimal_places=2, help_text='Quantity × Unit Charge', max_digits=10, validators=[django.core.validators.MinValueValidator(Decimal('0.00'))])),
                ('item_order', models.IntegerField(default=0, help_text='Display order in bill')),
                ('procedure_bill', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='opd.procedurebill')),
                ('procedure', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='bill_items', to='opd.proceduremaster')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('billed_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='created_opd_bills', to=settings.AUTH_USER_MODEL)),
                ('doctor', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='opd_bills', to='doctors.doctorprofile')),
                ('visit', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='opd_bill', to='opd.visit')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('filled_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='filled_template_responses', to=settings.AUTH_USER_MODEL)),
                ('reviewed_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='reviewed_template_responses', to=settings.AUTH_USER_MODEL)),
                ...
                ('visit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='template_responses', to='opd.visit')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('created_by', models.ForeignKey(help_text='Doctor who created the note', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='created_clinical_notes', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['name'],
                'indexes': [models.Index(fields=['code'], name='proc_package_code_idx'), models.Index(fields=['is_active'], name='proc_package_active_idx')],
            },
        ),
        migrations.AddIndex(
            model_name='visit',
