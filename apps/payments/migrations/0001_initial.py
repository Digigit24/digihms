    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['user', 'transaction_type'], name='transaction_user_id_9aa2b1_idx'), models.Index(fields=['created_at'], name='transaction_created_5c02ac_idx'), models.Index(fields=['category'], name='transaction_categor_bf503b_idx')],
            },
        ),
    ]
