    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                "ordering": ["name"],
                "indexes": [
                    models.Index(fields=["name"], name="specialties_name_ea5b66_idx"),
                    models.Index(fields=["code"], name="specialties_code_dec0e7_idx"),
                    models.Index(
                        fields=["is_active"], name="specialties_is_acti_0369e1_idx"
                    ),
                ],
            },
        ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="doctor_avai_doctor__b54d61_idx",
                    ),
                    models.Index(
                        fields=["is_available"], name="doctor_avai_is_avai_577882_idx"
                    ),
                ],
        ...
        migrations.AddIndex(
            model_name="doctorprofile",
            index=models.Index(
                fields=["medical_license_number"], name="doctor_prof_medical_d685ee_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="doctorprofile",
            index=models.Index(
                fields=["-created_at"], name="doctor_prof_created_04edc8_idx"
            ),
        ),
    ]
