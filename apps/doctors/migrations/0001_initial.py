    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('follow_up_fee', models.DecimalField(decimal_places=2, default=0, help_text='Follow-up consultation fee in INR', max_digits=10)),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['doctor', 'day_of_week'], name='doctor_avai_doctor__b54d61_idx'), models.Index(fields=['is_available'], name='doctor_avai_is_avai_577882_idx')],
